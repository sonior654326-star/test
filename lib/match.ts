...
const KEYWORD_TO_MECHANISM: [string[], MechanismTag][] = [
  ...
  [
    ["失败", "错误", "接管", "兜底", "失控", "安全", "关机", "熔断", "故障", "开关", "急停"],
    "failure-takeover",
  ],
  [
    ["人格", "性格", "角色", "拟人", "形象", "个性", "幽默", "检测", "深伪", "真假", "核验"],
    "personified-expression",
  ],
  [["透明", "解释", "可见", "状态", "坦白", "审计", "黑箱", "置信度", "披露"], "transparency"],
  [["信任", "依赖", "可靠", "放心", "接受", "依恋", "绑定"], "trust-building"],
  [
    ["目标", "对齐", "价值观", "意图", "动机", "边界", "护栏", "越界", "漂移"],
    "goal-alignment",
  ],
  [["隐私", "监视", "偷看", "数据", "秘密", "遗产"], "privacy-boundary"],
];
